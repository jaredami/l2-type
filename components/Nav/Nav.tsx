...
const MENU = {
  home: { text: "L2TYPE", href: "/" },
  practice: { text: "Practice", href: "/practice" },
        ...
        <li className={styles.navItem}>
          <Link href={MENU.practice.href}>
            <a className={styles.navLink}>
              ...
              <span className={styles.linkText}>{MENU.practice.text}</span>
            </a>
          </Link>
          <Link href={MENU.settings.href}>
            <a className={styles.navLink}>
              ...
              <span className={styles.linkText}>{MENU.settings.text}</span>
            </a>
          </Link>
        </li>
      </ul>
